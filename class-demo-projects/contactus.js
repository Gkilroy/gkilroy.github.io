...
function vlaidate_form6()
{
    ...
    //@@ optional refactor/optimization/code-reuse: create function
    //
    //validate_namel(elename.value) return true/false
    //validate_form_fields('name', elename.value) return true/false
    //
    //if (validate_name(elename.value))
    //
    ...
    //@@ optional refactor/optimization/code-reuse: create function
    //
    //validate_email(eleemail.value) return true/false
    //validate_form_fields('email', eleemail.value) return true/false
    //
    //if (validate_email(eleemail.value))
    //
    ...
    if(_form_error_array.length>0){
        ...
        //@@ optional refactor/optimization/code-reuse: create function
        //
        //generate_field_error_list_string(_form_error_array) return string
        //generate_field_error_list('string',_form_error_array) return string
        //
        ...
        */
        ...
        //- dom element code
        //
        //generate_field_error_list_element(_form_error_array) return DocumentElement
        //generate_field_error_list('element',_form_error_array) return DocumentElement
        //
        // - unit test function seperat from application
        //
        let ele_ul = document.createElement("ul");
